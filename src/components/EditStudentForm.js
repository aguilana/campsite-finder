...
const EditStudentForm = ({studentId}) => {
  ...
  return (
    ...
    <input type="text" value={firstName} name="firstname" placeholder="firstname" onChange={(e)=>setFirstName(e.target.value)} />
    ...
    <input type="number" value={gpa} name="gpa" placeholder="GPA" onChange={(e)=>setGpa(e.target.value)} />
